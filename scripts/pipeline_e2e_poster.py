...
#
# denoise_regional_velocity_blended() / load_and_encode_ref_image() moved to
# src/tendoo/velocity_blending.py (2026-09) and imported at the top of this file --
# this is the production sampling algorithm tendoo.demo_server's real-inference path
# depends on directly, so it now lives in src/tendoo/ as the single source of truth
# instead of being defined in this scripts/ file that the live server had to reach
# into. This script's own run_e2e_case() standalone test harness below keeps working
# unchanged, just calling the imported versions.
# ==================================================================================================
