...
def generate_tiktok_poster(
    ...
    # 1. Render Glyphs
    print("\n[Step 1/5] Rendering Vietnamese Typography Bitmaps...")
    # Title box: wide banner across upper canvas (e.g. 512 x 160)
    ...
    print("\n[Step 4/5] Preparing Multi-Context Time-Offset Tokens...")
    lat_h = height // 16
    lat_w = width // 16
