#!/usr/bin/env python3
"""
scripts/create_demo_studio_notebook.py

Generates demo_studio.ipynb in the repository root for interactive, zero-port-required
demonstration directly inside JupyterLab.
"""
...
def build_notebook():
        ...
        "cells": [
            ...
            },
            {
                ...
                "source": [
                    ...
                    "                )\n",
                    "                \n",
                    "                z_clean_aux = z_clean.to(DEVICE_AUX, dtype=AE_DTYPE)\n",
    ...
    out_file = Path(__file__).resolve().parent.parent / "demo_studio.ipynb"
    with open(out_file, "w", encoding="utf-8") as f:
        json.dump(nb, f, indent=2, ensure_ascii=False)

    print(f"[OK] Generated demo_studio.ipynb successfully at: {out_file}")
