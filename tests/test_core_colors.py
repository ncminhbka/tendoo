"""
tests/test_core_colors.py

Covers src/tendoo/core/colors.py (WCAG contrast / hue-harmony color engine -- merged
2026-09-13 from the former `layouts/color_engine.py`, see that module's docstring).
