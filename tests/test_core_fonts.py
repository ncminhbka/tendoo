...
from tendoo.core.base import PosterContent
...
def test_resolve_font_missing_file_falls_back_gracefully(tmp_path, monkeypatch):
    ...
    import tendoo.core.fonts as font_engine_mod
...
def test_render_poster_with_explicit_font(font_key, category, tmp_path):
    ...
    out_path = tmp_path / f"test_font_{font_key}.png"
