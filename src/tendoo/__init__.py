...
3. tendoo.layouts:
   - (2026-09-13: chỉ còn `layouts/base.py`, cầu nối tương thích BẮT BUỘC cho
     `tendoo_legacy`. Style/font/color/text engines đã chuyển hẳn vào `tendoo.core`.)
...
from tendoo.core.typography import balance_vietnamese_headline, normalize_text
from tendoo.engine.blocks import AdaptiveBlock
from tendoo.engine import OmniBlockLayout, get_layout, list_layouts
