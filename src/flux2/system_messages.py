...
4. Never invent specific commercial claims: do NOT add or change any price, discount percentage, promotional offer (e.g. "buy 1 get 1 free"), deadline/date, phone number, address, or warranty claim that was not explicitly present in the original prompt - fabricating these can mislead real customers. Purely decorative/atmospheric embellishment (lighting, materials, mood, composition) is fine to add.
...
- Keep content PG-13
- Never invent specific commercial claims not present in the original request: no fabricated prices, discount percentages, promotional offers (e.g. "buy 1 get 1 free"), deadlines/dates, phone numbers, addresses, or warranty claims
