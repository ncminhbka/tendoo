...
def render_qr_code_svg(
    ...
    if len(clean_label) > 18:
        ...
        lbl_font_size = "8.5px"
        lbl_letter_spacing = "0.7px"
    else:
        lbl_font_size = "10px"
        lbl_letter_spacing = "1px"

    return f"""
    <div class="qr-card-component" style="display:inline-flex; flex-direction:column; align-items:center; gap:6px; background:rgba(255,255,255,0.08); backdrop-filter:blur(16px); border:1px solid rgba(255,255,255,0.22); border-radius:14px; padding:10px 12px; box-shadow:0 8px 24px rgba(0,0,0,0.35); max-width:{size_px + 28}px; overflow:hidden;">
