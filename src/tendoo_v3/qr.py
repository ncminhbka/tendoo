...
def render_scannable_qr_component(
    ...
    if qr_b64:
        return f"""
        <div class="qr-card-component" style="display:inline-flex; flex-direction:column; align-items:center; gap:6px; background:rgba(255,255,255,0.08); backdrop-filter:blur(16px); border:1px solid rgba(255,255,255,0.22); border-radius:14px; padding:8px 10px; box-shadow:0 8px 24px rgba(0,0,0,0.35); max-width:{size_px + 28}px; overflow:hidden;">
