...
TEMPLATE_CATALOG: Dict[str, Dict[str, Any]] = {
    ...
    "type_showcase": {
        ...
        "capacity_chars": {"1:1": 365, "9:16": 365, "16:9": 109, "4:5": 365},
        "capacity_chars_safe": {"1:1": 365, "9:16": 365, "16:9": 365, "4:5": 365},
        "slots": {
            "hero": {},
            "subhead": {},
            "badge": {},
    ...
    "quote_spotlight": {
        "name": "Trích Dẫn Tâm Điểm",
        "specialized": True,
        "llm_hint": "Đánh giá: CÂU TRÍCH DẪN là chữ to nhất, hero = nhãn nhỏ; cột chữ trái/phải (orientation), ảnh khách phía đối diện.",
        "hint": "Thẻ đánh giá theo thực hành thiết kế: câu trích dẫn là chữ lớn nhất, sao + nhãn (hero) + tên người + CTA/cửa hàng nhỏ. Không subhead, không extra_texts. orientation 'left' (cột chữ trái, chủ thể lệch phải) hoặc 'right'; 9:16 dải chữ ở dưới.",
        "has_mask": True,
        "mask_preset": "quote_column",
        "default_orientation": "left",
        "visual_intents": ["testimonial_trust"],
        "capacity_chars": {"1:1": 377, "9:16": 235, "16:9": 93, "4:5": 235},
        "capacity_chars_safe": {"1:1": 377, "9:16": 377, "16:9": 377, "4:5": 377},
        "slots": {
            "hero": {},
