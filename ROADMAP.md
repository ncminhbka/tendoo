...
| **6** | Template mới — **chỉ cho các ô trống mà bản đồ lần 2 chỉ ra** | Mỗi cái: 2 file + 16-case suite đạt §4.5 | Dự kiến 3–5 cái, không phải 24. Band S showcase chuyển sang GĐ 9 (§10.8). **Ứng viên theo số đo lần 3 (26/09):** (a) thiết kế lại thẻ đánh giá quanh câu trích dẫn (C1 1/33, §8); (b) intent `festive_event` chỉ có 1 template → Cổng 3 báo lỗ hổng mọi khi vượt sức chứa; (c) khung 16:9 của `sandwich_top_heavy`/`grand_opening_banner` sức chứa thẩm mỹ chỉ 64 |
