...
| 2 | **Thành viên** | `font`/`text_effect`/`template`/`intent` phải thuộc danh mục đóng | Rơi về mặc định hợp lệ | ⚠️ có một phần, cần rà lại |
| 3 | **Dung lượng** | Ký tự thật vs capacity đo được | Reroute sang band lớn hơn | ❌ **CHƯA CÓ** |
| 4 | **Tràn** | Đo DOM sau render: có phần tử nào kẹt ở sàn mà vẫn tràn không | Log + reroute + đánh dấu case | ❌ **CHƯA CÓ** (v1 từng có, v3 đánh mất) |
